...
<img align="bottom" src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExZWJianN6bzV1cG4ydTYyMDN4bDZmbnh5aWNqY3l0ajcwemp0Z3Y0NyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/78XCFBGOlS6keY1Bil/giphy.gif" width="200" alt="Coding GIF" style="margin-top: 60px;" />
...
- **How much chaos can you handle?** Experience it at [staggeringbeauty.com](http://www.staggeringbeauty.com/)

### Philosophy

> "Rational in the fullness of time" - I build what feels right before it’s obvious, then let time prove it. Currently exploring how AI changes everything about software development.

<details>
<summary>Random Facts</summary>

- Treat AI like a co-founder that never sleeps
- Coffee → code → content → repeat (occasionally touch grass)
- Usually running more experiments than I can finish
- If it’s boring, I’ll probably automate it
- I’d rather ship v1 than plan v10
- Ideas are cheap, execution compounds
- Most “overnight” ideas took weeks of thinking
