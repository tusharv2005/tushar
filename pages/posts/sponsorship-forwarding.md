...
lang: en
duration: 10min
description: An initiative to support open-source ecosystem by Tushar Varshney.
---
...
## Tushar Varshney's Collective

So, I came up with the idea of creating my personal collective: {Tushar Varshney Collective}
...
- {Sponsor Tushar Varshney on Open Collective|https://opencollective.com/antfu} - To sponsor the dependencies and ecosystem of the projects Tushar maintains.
- {Sponsor Tushar Varshney on GitHub Sponsors|https://github.com/sponsors/antfu} - To sponsor Tushar's personal work on open-source projects.
